    ...
    <div className="mx-auto max-w-3xl rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm">
      <div className="space-y-6">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold text-slate-900">Access your account</h1>
          <p className="mt-2 text-slate-600">Enter your email and password to continue shopping.</p>
        </div>
